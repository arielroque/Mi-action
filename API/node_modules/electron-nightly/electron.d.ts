// Type definitions for Electron 9.0.0-nightly.20191220
...
Move the given file to trash and returns a boolean status for the operation.
     ...
     * Resolve with an object containing the following:
     *
     * * `success` Boolean - whether or not the path was successfully opened in the
     * desktop's default manner.
     * * `errorMessage` String (optional) - The error message corresponding to the
     * failure if a failure occurred, otherwise empty string.
     * 
Open the given file in the desktop's default manner.
     */
    openPath(path: string): Promise<Electron.OpenPathReturnValue>;
    /**
...
See webContents.sendInputEvent for detailed description of `event` object.
  ...
  interface OpenPathReturnValue {
    /**
     * whether or not the path was successfully opened in the desktop's default manner.
     */
    success: boolean;
    /**
